...
class ReferenceRepository:
    ...
    @staticmethod
    def find_reference_by_id(cursor,ref_id) ->List[ReferenceDAO]:
    ...
    @staticmethod
    def insert_reference(cursor,reference_id, obligation_id, document_id, page=None, text=None,
        ...
        insert_statement = """
            ...
            VALUES (?,?, ?, ?, ?, ?, ?)
        """
        cursor.execute(insert_statement, (obligation_id, document_id, page, text, chapter, subchapter))
        return ReferenceDAO(id=cursor.lastrowid, obligation_id=obligation_id, document_id=document_id,
    ...
    @staticmethod
    def delete_reference(cursor, reference_id):
        delete_statement = "DELETE FROM referinte WHERE id = ?"
        cursor.execute(delete_statement, (reference_id,))